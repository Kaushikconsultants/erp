  ...
  return (
    <div className="page-container" style={{ padding: "24px", maxWidth: "1400px", margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px", marginBottom: "24px" }}>
        ...
        <div className="glass-panel" style={{ padding: "20px", borderLeft: "4px solid #ea580c" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "20px" }}>
        ...
        <Link href="/accounting/financial-statements" style={{ textDecoration: "none", color: "inherit" }}>
          <div className="glass-panel" style={{ padding: "24px", height: "100%", display: "flex", flexDirection: "column", transition: "transform 0.15s ease", cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
              <div style={{ padding: "12px", borderRadius: "12px", background: "#e0e7ff", color: "#4338ca" }}>
                <Scale size={24} />
              </div>
              <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "2px 8px", borderRadius: "6px", background: "#ecfdf5", color: "#059669" }}>
                AUDIT READY
              </span>
            </div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "0 0 6px 0" }}>Financial Statements</h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", margin: "0 0 16px 0", flex: 1 }}>
              Real-time Schedule III Balance Sheet, Trading Account, Profit & Loss Statement, and Trial Balance with Excel/CSV export.
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#4f46e5", fontWeight: 700, fontSize: "0.875rem", marginTop: "auto" }}>
        ...
        <Link href="/accounting/chart-of-accounts" style={{ textDecoration: "none", color: "inherit" }}>
          <div className="glass-panel" style={{ padding: "24px", height: "100%", display: "flex", flexDirection: "column", transition: "transform 0.15s ease", cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
              ...
              <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "2px 8px", borderRadius: "6px", background: "#fef3c7", color: "#92400e" }}>
                COA MASTER
              </span>
            </div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "0 0 6px 0" }}>Chart of Accounts</h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", margin: "0 0 16px 0", flex: 1 }}>
        ...
        <Link href="/accounting/vouchers" style={{ textDecoration: "none", color: "inherit" }}>
          <div className="glass-panel" style={{ padding: "24px", height: "100%", display: "flex", flexDirection: "column", transition: "transform 0.15s ease", cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
              ...
              <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "2px 8px", borderRadius: "6px", background: "#f3e8ff", color: "#7e22ce" }}>
                DOUBLE-ENTRY
              </span>
            </div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "0 0 6px 0" }}>Journal & Contra Vouchers</h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", margin: "0 0 16px 0", flex: 1 }}>
        ...
        <Link href="/accounting/ageing" style={{ textDecoration: "none", color: "inherit" }}>
          <div className="glass-panel" style={{ padding: "24px", height: "100%", display: "flex", flexDirection: "column", transition: "transform 0.15s ease", cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
              ...
              <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "2px 8px", borderRadius: "6px", background: "#ffedd5", color: "#c2410c" }}>
                0-90+ DAYS
              </span>
            </div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "0 0 6px 0" }}>Outstanding Ageing Analysis</h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", margin: "0 0 16px 0", flex: 1 }}>
        ...
        <Link href="/accounting/bank-reconciliation" style={{ textDecoration: "none", color: "inherit" }}>
          <div className="glass-panel" style={{ padding: "24px", height: "100%", display: "flex", flexDirection: "column", transition: "transform 0.15s ease", cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
              ...
              <span style={{ fontSize: "0.75rem", fontWeight: 700, padding: "2px 8px", borderRadius: "6px", background: "#ecfdf5", color: "#047857" }}>
                BRS ENGINE
              </span>
            </div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "0 0 6px 0" }}>Bank Reconciliation (BRS)</h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", margin: "0 0 16px 0", flex: 1 }}>
