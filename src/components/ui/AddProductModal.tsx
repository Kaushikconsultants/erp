      ...
      <div className="modal-content glass-panel animate-in">
        ...
        <form onSubmit={handleSubmit} className="modal-body" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
          ...
          <div className="form-group">
            ...
            <input type="number" name="weight" step="0.01" placeholder="e.g. 0.25 (optional, defaults to category weight)" />
          </div>
          ...
          <div className="form-group">
            ...
            <textarea name="description" rows={3} placeholder="Premium quality sportswear..." style={{
              padding: '12px 16px',
