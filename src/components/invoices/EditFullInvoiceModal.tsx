...
export default function EditFullInvoiceModal({
  ...
  const [activeTab, setActiveTab] = useState<"items" | "customer" | "terms">("items");
  ...
  return (
    ...
    >
      ...
      >
        {/* ─── SYSTEM-THEMED CLEAN MODAL HEADER ─── */}
        <div style={{
          backgroundColor: "#ffffff",
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <button
              ...
              style={{
                ...
                gap: "6px",
                transition: "all 0.15s ease",
                backgroundColor: activeTab === "items" ? "#0f172a" : "#f8fafc",
                color: activeTab === "items" ? "#ffffff" : "#475569",
                border: activeTab === "items" ? "1px solid #0f172a" : "1px solid #e2e8f0"
              }}
            >
              <Package size={14} /> Line Items & Pricing
              <span style={{
                fontSize: "0.68rem",
                padding: "1px 6px",
                borderRadius: "10px",
                backgroundColor: activeTab === "items" ? "rgba(255,255,255,0.2)" : "#e2e8f0",
                color: activeTab === "items" ? "#ffffff" : "#475569"
              }}>
                {items.length}
              </span>
            ...
            <button
              ...
              style={{
                ...
                gap: "6px",
                transition: "all 0.15s ease",
                backgroundColor: activeTab === "customer" ? "#0f172a" : "#f8fafc",
                color: activeTab === "customer" ? "#ffffff" : "#475569",
                border: activeTab === "customer" ? "1px solid #0f172a" : "1px solid #e2e8f0"
              }}
            >
              <Building2 size={14} /> Customer & Billing
            </button>
            ...
            <button
              ...
              style={{
                ...
                gap: "6px",
                transition: "all 0.15s ease",
                backgroundColor: activeTab === "terms" ? "#0f172a" : "#f8fafc",
                color: activeTab === "terms" ? "#ffffff" : "#475569",
                border: activeTab === "terms" ? "1px solid #0f172a" : "1px solid #e2e8f0"
              }}
            >
              <Calendar size={14} /> Dates & Terms
            </button>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", fontSize: "0.82rem" }}>
            <span style={{ color: "#64748b" }}>
              Grand Total: <strong style={{ color: "#0f172a", fontSize: "0.92rem" }}>₹{calculations.totalAmount.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</strong>
            </span>
          ...
          <form onSubmit={handleSaveInvoice} style={{ overflowY: "auto", flex: 1, padding: "20px 24px" }}>
            ...
            {activeTab === "items" && (
              <div>
                <div style={{
                  ...
                  <div>
                    ...
                    <p style={{ margin: "2px 0 0 0", fontSize: "0.76rem", color: "#64748b" }}>
                      Adjust quantities, rates, item discounts, and tax rates. Taxes calculate in real time.
                    </p>
                  </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: "16px" }}>
                  {/* Left Column: Quick Notes & Tax Mode */}
                  <div style={{
                    backgroundColor: "#f8fafc",
                    border: "1px solid #e2e8f0",
                    borderRadius: "10px",
                    ...
                    <div>
                      <label style={{ display: "block", fontSize: "0.76rem", fontWeight: 600, color: "#475569", textTransform: "uppercase", letterSpacing: "0.03em", marginBottom: "5px" }}>
                      ...
                      <textarea
                        ...
                        placeholder="Internal instructions, PO reference, or dispatch remarks..."
                        style={{
                          width: "100%",
                          padding: "8px 12px",
                          borderRadius: "8px",
            ...
            {activeTab === "customer" && (
              <div style={{
                ...
                <div style={{
                  ...
                  <div>
                    <span style={{ fontSize: "0.82rem", fontWeight: 700, color: "#0f172a" }}>Select Existing Customer:</span>
                    <p style={{ margin: "2px 0 0 0", fontSize: "0.74rem", color: "#64748b" }}>
                      Picking a customer auto-fills billing address, GSTIN, and tax rates.
                    </p>
                  </div>
                  <select
                    value={customerId}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Shop / Office address, city, pincode..."
                      style={{
                        width: "100%",
                        padding: "9px 12px",
                        borderRadius: "8px",
              ...
              <div style={{
                ...
                <div>
                  ...
                  <textarea
                    ...
                    value={notes}
                    onChange={e => setNotes(e.target.value)}
                    placeholder="Enter any internal notes or quotation reference..."
                    style={{
                      width: "100%",
                      padding: "10px 12px",
                      borderRadius: "8px",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "0.8rem", color: "#64748b" }}>
                Invoice Total: <strong style={{ color: "#0f172a" }}>₹{calculations.totalAmount.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</strong>
              </div>
